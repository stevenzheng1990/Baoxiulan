    ...
    <>
          ...
          <ol className="fac-grid">
            {PROGRAMS.map((p, i) => (
              <li
                ...
                style={{ ['--d' as string]: `${(i % 2) * 0.06}s` }}
              >
                <span className="fac-card-bd fac-card-bd-t" aria-hidden="true" />
                <span className="fac-card-bd fac-card-bd-r" aria-hidden="true" />
                <span className="fac-card-bd fac-card-bd-b" aria-hidden="true" />
                <span className="fac-card-bd fac-card-bd-l" aria-hidden="true" />
                ...
                <header className="fac-card-head">
                  ...
                  <span className="fac-card-no">No. {String(i + 1).padStart(2, '0')}</span>
                </header>

                <h3 className="fac-card-title">{p.name}</h3>

                <div className="fac-card-tags">
                  {p.age && <span className="fac-card-tag fac-tag-age">{p.age}</span>}
                ...
                <div className="fac-card-divider" aria-hidden="true">
                  <span className="fac-card-divider-line" />
                  <span className="fac-card-divider-text">训练重点</span>
                  <span className="fac-card-divider-line" />
                </div>
      ...
      <style>{`
        ...
        .fac-card {
          ...
          display: flex;
          flex-direction: column;
          gap: clamp(0.85rem, 1.3vw, 1.05rem);
        ...
        .fac-card:hover {
          ...
          box-shadow: 0 24px 56px -32px rgba(0,3,163,0.28);
        }
        ...
        .fac-card-bd-t { top: 0; left: 0; height: 1px; width: 100%; }
        .fac-card-bd-r { top: 0; right: 0; width: 1px; height: 100%; }
        .fac-card-bd-b { bottom: 0; right: 0; height: 1px; width: 100%; }
        .fac-card-bd-l { bottom: 0; left: 0; width: 1px; height: 100%; }
        ...
        .fac-card:hover .fac-card-corner { opacity: 0.85; width: 18px; height: 18px; }
        ...
        .fac-card:hover .fac-card-icon { transform: scale(1.06); }
        ...
        .fac-card:hover .fac-card-title { transform: translateX(3px); }
        ...
        .fac-card-tag.fac-tag-age {
          border-color: var(--fac-gold-line);
          color: var(--fac-gold);
        }
        .fac-card:hover .fac-card-tag { border-color: rgba(0,3,163,0.3); }
        .fac-card:hover .fac-card-tag.fac-tag-age { border-color: var(--fac-gold); }
        ...
        .fac-card-divider-line {
          flex: 1; height: 1px;
          background: var(--fac-gold-line);
        }
        .fac-card-divider-text {
          font-family: var(--serif-cn);
          font-size: 0.66rem;
          letter-spacing: 0.32em;
          padding-left: 0.32em;
        ...
        @media (max-width: 480px) {
          ...
          .fac-card-title { letter-spacing: 0.04em; }
        }
